...
var zen_coding = (function(){
	 ...
	 * @return {String}
	 * -----
	 * В TopStyle не используется, так как редактор сам сохраняет отбивку.
	 */
	 ...
	 * @return {String}
	 * -----
	 * В TopStyle пока всегда возвращаем 'text/html'. 
	 */
	...
	return {
		 ...
		 * @return {String|null}
		 * -----
		 * В TopStyle всегда возвращает выделенную область.
		 */
		 ...
		 * -----
		 * В TopStyle не используется.
		 * Курсор позиционируется редактором автоматически в точку певого вхождения символа "|".
		 */
		 ...
		 * @return {String|null}
		 * -----
		 * TopStyle поддерживает только XHTML, ASP[VB], PHP, CFML, JSP
		 */
